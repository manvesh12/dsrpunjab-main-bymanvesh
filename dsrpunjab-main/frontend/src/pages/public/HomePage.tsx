  ...
  return (
    <div className="public-portal min-h-screen bg-[#f5f5f5] text-slate-800 dark:bg-slate-950 dark:text-slate-100">
      ...
      <main id="main-content">
        ...
        <section id="districts" className="bg-[#f5f5f5] py-10 dark:bg-slate-900"><div className="govt-container"><div className="flex flex-wrap items-end justify-between gap-3"><SectionBar title="District Directory" subtitle="District covered under the Rupnagar DSR portal." /><span className="text-xs font-bold text-[#123c6e] dark:text-blue-300">1 District</span></div><div className="mt-4 grid border-l border-t border-slate-300 bg-white sm:grid-cols-3 lg:grid-cols-6 dark:border-slate-700 dark:bg-slate-950">{districts.map((district) => <div key={district} className="district-cell"><MapPinned size={13} className="text-[#b36a0d]" /> {district}</div>)}</div></div></section>
      </main>
